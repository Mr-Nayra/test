...
export const TestimonialsCarouselData = [
  ...
  },
  {
    ...
    description:
      "Model observability is one of the key considerations as we look to use foundation models at our organisation and it’s great to see UpTrain building tools which help in monitoring and refining large language models ",
  },
  {
