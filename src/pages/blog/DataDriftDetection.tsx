      ...
      <div className={classes.container}>
        <div className={classes.tableContainer}>
          <ul>
            ...
            <li className={classes.listItem}>
              <a href="#conclusion" className={classes.nestedListItemLink}>
        ...
        <div className={classes.mainContainer}>
          ...
          <div className={classes.mainContent}>
            ...
            <div id="data-distribution-drift">
              <p className={classes.description}>
            ...
            <div id="statistical-methods-to-detect-data-drifts">
              <p className={classes.description}>
            ...
            <div id="population-stability-index">
              <p className={classes.description}>
                <b>a) Population Stability Index(PSI)</b>
              </p>
              <p className={classes.description}>
                It is a metric that measures the shift in population over time
                between the target (test data) at the deployment time and the
                target at the current period. The below image shows an example
                of how the population distribution has changed.
              </p>
              <div className={classes.imageContainer}>
                <img
            ...
            <div id="kullback-leibler-divergence">
              <p className={classes.description}>
              ...
              <p className={classes.description}>
                ...
                represented by “||’. This metric is often referred to as
                ‘relative entropy’ , as it uses the entropy of probability
            ...
            <div id="jensen-shannon-distance">
              <p className={classes.description}>
                <b>c) Jensen-Shannon Distance</b>
              </p>
              <p className={classes.description}>
                The JSD also measures the difference in probability
                distributions similar to KL divergence, with two major changes.
                The JSD metric calculates a normalized score using the KL
                divergence formula discussed in the previous section, as shown
                below.
              </p>
            ...
            <div id="kolmogorov-smirnov-test">
              <p className={classes.description}>
                <b>c) Kolmogorov-Smirnov Test</b>
              </p>
              <p className={classes.description}>
                The K-S test is different from other tests as it is a
                non-parametric test. What do we mean by non-parametric tests?
                They do not make any assumptions on the nature of underlying
                data distribution.
              </p>
              <p className={classes.description}>
            ...
            <div id="page-hinkley-method">
              <p className={classes.description}>
                <b>e) Page-Hinkley Method</b>
              </p>
              <p className={classes.description}>
                It is a commonly used method to detect drift in incoming data
                and provide warnings to the ML teams. In this method, the mean
                value is dynamically updated as there is an inflow of new data.
                At any point when the mean value would exceed the threshold
                value ( set by the user based on mean observed during
                deployment), it provides drift detection alarms. In practical
                usage, this method leverages the CUMSUM control chart to
                identify shifts.
              </p>
              <p className={classes.description}>
