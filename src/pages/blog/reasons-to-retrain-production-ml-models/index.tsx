  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta
          name="description"
          content="Reasons for model performance degradation like concept drift, data drift, distribution shift. How to identify edge cases in Machine learning models"
        />
      </Head>
      ...
      <div className={classes.root}>
        <div className={classes.container}>
          <div className={classes.tableContainer}>
            <DefaultTableList data={whyDoWeTableList} />
          </div>
          ...
          >
            <div>
              ...
              <p>
                ...
                service is ensured. However, model retraining doesn&apos;t
                change the model&apos;s algorithm; it simply means updating the
                model&apos;s dataset to get accurate results even after a long
                time.
              </p>
              ...
              <p className="blog-pt" id="edge-cases">
                ...
                with that rare 1% possibility. Let&apos;s talk about our
                example. In this case, let&apos;s say we have an actor who only
                works with big production houses, but in a particular case, the
                script of the movie attracts him, and he ends up working with a
                small local production house. Now, this is an edge case for our
                model. Another instance of an edge case is where a less famous
                actor has a big break and ends up working in a high-budget film
                with a very famous director and producer, contrary to his
                previous low-budget movie castings. While we collect the dataset
                and are provisioning our model, we might not consider these
                cases, but if such a case happens, we need to collect such data
                intently and retrain our model to include these cases as well.
              </p>
              ...
              <p>
                ...
                time. Let&apos;s say with all the input data earlier described,
                we notice that supporting cast plays a key role in determining
