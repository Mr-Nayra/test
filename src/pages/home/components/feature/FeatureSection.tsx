              ...
              <div className={classes.content}>
                ...
                {active === 3 && (
                  <div>
                    ...
                    <p className={classes.description}>
                      ...
                      incorporate your domain-specific knowledge which are used
                      to filter out specific subsets of data which can be used
                ...
                {active === 4 && (
                  <div>
                    ...
                    <p className={classes.description}>
                      With UpTrain, you can attach your existing data
                      annotation, model training, and deployment pipelines to
                      activate a completely automated continuous model
                      improvement cycle
                    </p>
                    <div className={classes.whiteBox}>
                      <div className={classes.blackBox}>
